...
cd C:/Futures/Knowledge-Prompting-for-FSAR/ && CUDA_VISIBLE_DEVICES=0 python tsl_fsv_w_knowledge.py --test_video_path  C:/Futures/Knowledge-Prompting-for-FSAR/data_car/RGB_20s_frame_fps_5  \
--manual_seed 10 \
--test_list_path C:/Futures/Knowledge-Prompting-for-FSAR/data_car/data_spilts/meta_test.txt \
--dataset ucf101 \
--train_crop random \
...
--clip_model_depth 34 \
--n_threads 1 \
--result_path C:/Futures/Knowledge-Prompting-for-FSAR/results_newlr/car_5_1shot/test_knowbase_1e-4_finegym_ins \
--test_way 5 \
--shot 1 \
--query 1 \
--resume_path C:/Futures/Knowledge-Prompting-for-FSAR/results_newlr/car_5_1shot/train_knowbase_1e-4_finegym_ins/save_50.pth \
--emb_dim 491 \
--batch_size 64 \
--lr 0.05 \
--nepoch 10 \
