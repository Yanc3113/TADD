...
--clip_model_depth 34 \
--n_threads 1 \
--result_path C:/Futures/Knowledge-Prompting-for-FSAR/results_newlr/car_3_5shot/test_knowbase_1e-4_finegym_ins \
--test_way 3 \
--shot 5 \
--query 1 \
--resume_path C:/Futures/Knowledge-Prompting-for-FSAR/results_newlr/car_3_5shot/train_knowbase_1e-4_finegym_ins/save_50.pth \
--emb_dim 491 \
--batch_size 64 \
--lr 0.05 \
--nepoch 10 \
